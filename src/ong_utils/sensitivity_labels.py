...
Adapted from https://gist.github.com/brunomsantiago/c79d17bf74c4c78c51debf7f7e0bafb5,
but modified to get custom properties directly from a sample office doc parsing XML (as powershell is
too slow reading them but acceptable writing)
Sample use:
...
class SensitivityLabel:
    ...
    def __init__(self, label_or_template: str):
        """
        Creates a new SensitivityLabel instance, based on a guid or in a excel/word/powerpoint file to use as a template
        """
    ...
    def apply(self, filename: str):
        ...
        apply_label(filename, self.label_id, powershell=self.powershell, stdout_encoding=self.stdout_encoding)
